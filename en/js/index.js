...
var funcs = {
	...
	contractExpand: function() {
		if (this.innerHTML == "expand") {
			var questionNumber = this.parentNode.parentNode.id.charAt(18);
			this.parentNode.parentNode.style.display="none";
			document.getElementById("questionExpanded" + questionNumber).style.display = "block";
		}
		if (this.innerHTML == "shrink") {
			var questionNumber = this.parentNode.parentNode.id.charAt(16);
			this.parentNode.parentNode.style.display="none";
			document.getElementById("questionContracted" + questionNumber).style.display = "block";
		}
	}
...
window.onload = function () {
	...
	document.getElementById("linkItalian").onclick = function() {
		window.location = window.location.href.replace("/en", "/it");
	};
	...
	// Add handlers for contracting / expanding questions
	var conExp = document.getElementsByClassName("contractExpand");
	for ( var i=0; i < conExp.length; i++ ) {
		conExp[i].onclick = funcs.contractExpand;
	}
